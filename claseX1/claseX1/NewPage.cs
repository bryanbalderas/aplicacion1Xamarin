...
namespace claseX1
{
    class NewPage : ContentPage
    {
        ...
        public NewPage()
        {
            ...
            noteEditor.SetBinding(Editor.TextProperty, nameof(NewPageViewModel.NoteText));
            ...
            saveButton.SetBinding(Button.CommandProperty, nameof(NewPageViewModel.SaveNoteCommand));
            ...
            deleteButton.SetBinding(Button.CommandProperty, nameof(NewPageViewModel.EraseNotesCommand));
            ...
            collectionView.SetBinding(CollectionView.ItemsSourceProperty, nameof(NewPageViewModel.Notes));
            collectionView.SetBinding(CollectionView.SelectedItemProperty, nameof(NewPageViewModel.SelectedNote));
            collectionView.SetBinding(CollectionView.SelectionChangedCommandProperty, nameof(NewPageViewModel.NoteSelectedCommand));
